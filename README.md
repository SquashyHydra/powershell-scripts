...
```powershell
& ([ScriptBlock]::Create((irm https://raw.githubusercontent.com/SquashyHydra/powershell-scripts/main/Create-Wizard101Shortcut.ps1))) -GamePath "C:\Path\To\Wizard101.exe"
```